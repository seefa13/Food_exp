...
const education = ['Vocational School','High School','Bachelor','Master','PhD'];
const occupation = ['Unemployed and searching','Unemployed and not searching','Student','Employed','Self-employed'];
...
const shuffleQuestions = [ 
    {
        question: "Please indicate whether you agree with the following statement: I deliberately take small helpings as a means of controlling my weight.",
        name: "QT1",
        type: "scale",
    },
    {
        question: "Please indicate whether you agree with the following statement: I consciously hold back at meals in order not to weight gain.",
        name: "QT2",
        type: "scale",
    },
    {
        question: "Please indicate whether you agree with the following statement: I do not eat some foods because they make me fat.",
        name: "QT3",
        type: "scale",
    },
    {
        question: "Please indicate whether you agree with the following statement: I frequently avoid 'stocking up' on tempting foods?",
        name: "QT4",
        type: "scale",
    },
    {
        question: "Please indicate whether you agree with the following statement: I am very likely to consciously eat less than I want?",
        name: "QT5",
        type: "scale",
    },
    {
        question: "On a scale of 1 to 5, where 1 means no restraint in eating (eating whatever you want whenever you want it) and 5 means total restraint (constantly limiting food intake and never 'giving in'), how much would you agree with the following statement: I am very restrained in eating?",
        name: "QT6",
        type: "scale",
    },
    {
        question: "Please indicate whether you agree with the following statement: When I feel anxious, I find myself eating.",
        name: "QT7",
        type: "scale",
    },
    {
        question: "Please indicate whether you agree with the following statement: When I feel blue, I often overeat.",
        name: "QT8",
        type: "scale",
    },
    {
        question: "Please indicate whether you agree with the following statement: When I feel lonely, I console myself by eating.",
        name: "QT9",
        type: "scale",
    },
    {
    ...
    {
        question: "During the last 7 days, how much time did you spend sitting (in full hours)?",
        name: "QT13",
        type: "shortOpen",
        validate: validActivity,
        invalidMessage: warningActivity,
